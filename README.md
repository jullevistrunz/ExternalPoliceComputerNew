# [ExternalPoliceComputer 1.5.0](https://www.lcpdfr.com/downloads/gta5mods/scripts/45400-externalpolicecomputer/)
...
- `printCitationsOnSubmit`: If set to `true`, EPC will send citation data to PR when submitted
- `showWeaponPermit`: If set to `true`, weapon permits will show on ped searches
- `showFishingPermit`: If set to `true`, fishing permits will show on ped searches
- `showHuntingPermit`: If set to `true`, hunting permits will show on ped searches
